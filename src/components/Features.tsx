...
export function Features() {
  return (
    <section id="features" className="px-4 py-24 sm:px-6 lg:px-8 scroll-mt-20 bg-slate-50/50 dark:bg-slate-900/20">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-20 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, i) => (
            <div
              key={feature.id}
              className="group rounded-2xl border border-slate-200/80 dark:border-slate-700/80 bg-white dark:bg-slate-900/50 p-6 shadow-soft dark:shadow-soft-dark card-hover"
