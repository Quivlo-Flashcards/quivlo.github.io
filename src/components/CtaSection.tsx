...
export function CtaSection() {
  return (
    <section className="relative px-4 py-12 sm:py-20 sm:px-6 lg:px-8 bg-slate-900 dark:bg-slate-950">
      <div className="mx-auto max-w-4xl">
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-br from-indigo-500 to-violet-600 px-5 py-10 text-center shadow-2xl shadow-indigo-500/20 dark:shadow-indigo-500/10 sm:px-10 sm:py-16">
          ...
          <a
            ...
            className="mt-6 sm:mt-8 inline-flex items-center justify-center gap-2 min-h-[44px] rounded-xl bg-slate-900 dark:bg-black px-6 py-4 text-base font-semibold text-white shadow-lg hover:bg-slate-800 dark:hover:bg-slate-900 transition-colors touch-manipulation"
          >
